...
pub const ASSET_INPUT_PROMPT: &str = "Please select asset or enter Coingecko API id. Type Q to Quit.\n";
pub const DATETIME_INPUT_PROMPT: &str = "Press Return for current price or enter UTC DateTime in a below format. Type 'Q' to Quit.
